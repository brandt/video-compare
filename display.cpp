        ...
        case SDLK_Y: {
          ...
          switch (new_mode) {
            case DiffMode::LegacyAbs:
              new_mode = forward ? DiffMode::AbsLinear : DiffMode::SignedDiverging;
              break;
            case DiffMode::AbsLinear:
              new_mode = forward ? DiffMode::AbsSqrt : DiffMode::LegacyAbs;
              break;
            case DiffMode::AbsSqrt:
              new_mode = forward ? DiffMode::SignedDiverging : DiffMode::AbsLinear;
              break;
            case DiffMode::SignedDiverging:
              new_mode = forward ? DiffMode::LegacyAbs : DiffMode::AbsSqrt;
              break;
          }
