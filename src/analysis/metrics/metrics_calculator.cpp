...
// NOTE: compute_structural_fingerprint and structural_correlation live in
// structural_fingerprint.cpp — kept out of this TU so the auto-align
// primitives don't pull in FormatConverter / filter / display headers.
